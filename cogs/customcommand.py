...
class CustomCommand(commands.Cog):
    ...
    async def courseinfo(self, ctx, *, args=None):
        ...
        if args == 'add' or args == 'a':
            ...
            # the check=lambda needs to verify a appropriate response
            ...
            if confirm.content.startswith('n') or confirm.content.startswith('N'):
                ...
                try:
                    ...
                    c.execute(sql, (cmdname.content, cmdcontext.content, cmdreturn.content, cmdhelp.content, str(ctx.author)))
                    conn.commit()
        ...
        if args == 'del' or args == 'd':
            await ctx.send("you have chosen delete\nComing soon")
            return
        # modify command
